...
from fog_node.resource_monitor import DeviceMetrics, ResourceMetrics, ResourceMonitor
...
class TestResourceMonitor:
    ...
    def resource_config(self):
        ...
        return {"max_cpu_usage": 0.8, "max_memory_usage": 0.75, "max_storage_gb": 100}
    ...
    async def test_get_capabilities(
        self, mock_disk, mock_memory, mock_cpu_freq, mock_cpu_count, resource_monitor
    ):
    ...
    async def test_get_current_usage(
        self, mock_disk, mock_memory, mock_cpu, resource_monitor
    ):
    ...
    async def test_can_handle_task(self, resource_monitor):
        ...
        with patch.object(
            resource_monitor, "get_available_resources"
        ) as mock_available:
            ...
            task_small = {"cpu": 30.0, "memory_gb": 4.0, "disk_gb": 10.0}
